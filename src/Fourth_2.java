...
class AbiturientException extends Exception {
    public AbiturientException(String mess) {
        super(mess);
    }
}
...
public class Fourth_2 {
    public static void main(String[] args) {
        try (Scanner scanner = new Scanner(System.in)) {
            ...
            if (m < 1){
                throw new AbiturientException("m должно быть больше нуля");
            }

            System.out.print("Искомый средний балл: ");
            double mean_mark = scanner.nextDouble();
            if (mean_mark <= 0){
                throw new AbiturientException("средний балл должен быть больше нуля");
            }
            ...
            if (n < 1){
                throw new AbiturientException("n должно быть больше нуля");
            }
